...
db.createCollection("province", {
    validator: {
        $jsonSchema: {
            bsonType: "object",
            required: ["province_id", "cities"],
            properties: {
                province_id: {
                    bsonType: "number",
                    description: "'province_id' must be an integer and is required"
                },
                cities: {
                    bsonType: "array",
                    uniqueItems: true,
                    items: {
                        ...
                        properties: {
                            id: {
                                bsonType: "number",
                                description: "'cities[i].id' must be an integer and is required"
                            },
                            name: {
                                bsonType: "string",
                                "description": "'cities[i].name' must be a string and is required"
                            }
                        }
                    }
                }
...
db.province.createIndex({"province_id": 1}, {unique: true})
...
db.province.insertMany([
    ...
    },
    {
        ...
        cities: [
            ...
            {id: 1608, name: 'KABUPATEN OGAN KOMERING ULU SE'},
            {id: 1609, name: 'KABUPATEN OGAN KOMERING ULU TI'},
            {id: 1610, name: 'KABUPATEN OGAN ILIR'},
            {id: 1611, name: 'KABUPATEN EMPAT LAWANG'},
            {id: 1612, name: 'KABUPATEN PENUKAL ABAB LEMATAN'},
    ...
    },
    {
        ...
        cities: [
            ...
            {id: 7107, name: 'KABUPATEN BOLAANG MONGONDOW UT'},
            {id: 7108, name: 'KABUPATEN SIAU TAGULANDANG BIA'},
            {id: 7109, name: 'KABUPATEN MINAHASA TENGGARA'},
            {id: 7110, name: 'KABUPATEN BOLAANG MONGONDOW SE'},
            {id: 7111, name: 'KABUPATEN BOLAANG MONGONDOW TI'},
    ...
    },
    {
        ...
        cities: [
            ...
            {id: 7309, name: 'KABUPATEN PANGKAJENE DAN KEPUL'},
    ...
    },
    {
        province_id: 81,
        cities: [
            {id: 8101, name: 'KABUPATEN MALUKU TENGGARA BARA'},
